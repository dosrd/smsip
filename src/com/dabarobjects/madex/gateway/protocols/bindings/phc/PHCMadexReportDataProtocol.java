...
import com.dabarobjects.madex.gateway.services.phc.ReportUplinkSyncPlug;
 ...
 * @author dabar
 */
public class PHCMadexReportDataProtocol implements MadexGatewayProcessingUnit {
        ...
        try {
            ...
            if (vBundle.getOperationSuccess()) {
                ...
                if (ok) {
                    ...
                    ReportUplinkSyncPlug rUplink = new ReportUplinkSyncPlug(dataAccess, mrt, mConf.getReportSynchPath(), phcCodeloc, "PHC");
